...
def get_hyper(hyper):
  return hyper.product([
      hyper.sweep('batch_size', [1, 2, 5, 10, 20]),
      hyper.sweep('message_passing_steps', [1, 2, 3, 4, 5]),
      hyper.sweep('num_training_epochs', [1, 5, 10, 20]),
      hyper.sweep('latent_size', [10, 20, 50, 100]),
  ])
